...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v2, v0, Landroid/support/v7/widget/CardView;->mShadowBounds:Landroid/graphics/Rect;

    .line 447
    new-instance v4, Landroid/support/v7/widget/CardView$1;

    invoke-direct {v4, v0}, Landroid/support/v7/widget/CardView$1;-><init>(Landroid/support/v7/widget/CardView;)V

    iput-object v4, v0, Landroid/support/v7/widget/CardView;->mCardViewDelegate:Landroid/support/v7/widget/CardViewDelegate;

    .line 123
    sget-object v2, Landroid/support/v7/cardview/R$styleable;->CardView:[I

    sget v3, Landroid/support/v7/cardview/R$style;->CardView:I
    ...
    sget v3, Landroid/support/v7/cardview/R$styleable;->CardView_cardBackgroundColor:I
    ...
    sget-object v6, Landroid/support/v7/widget/CardView;->COLOR_BACKGROUND_ATTR:[I
    ...
    sget v9, Landroid/support/v7/cardview/R$color;->cardview_light_background:I
    ...
    sget v9, Landroid/support/v7/cardview/R$color;->cardview_dark_background:I
    ...
    :goto_73
    sget v3, Landroid/support/v7/cardview/R$styleable;->CardView_cardCornerRadius:I
    ...
    .line 142
    .local v14, "radius":F
    sget v3, Landroid/support/v7/cardview/R$styleable;->CardView_cardElevation:I
    ...
    sget v3, Landroid/support/v7/cardview/R$styleable;->CardView_cardMaxElevation:I
    ...
    sget v6, Landroid/support/v7/cardview/R$styleable;->CardView_cardUseCompatPadding:I

    invoke-virtual {v2, v6, v5}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v6

    iput-boolean v6, v0, Landroid/support/v7/widget/CardView;->mCompatPadding:Z

    .line 145
    sget v6, Landroid/support/v7/cardview/R$styleable;->CardView_cardPreventCornerOverlap:I
    ...
    iput-boolean v6, v0, Landroid/support/v7/widget/CardView;->mPreventCornerOverlap:Z

    .line 146
    sget v6, Landroid/support/v7/cardview/R$styleable;->CardView_contentPadding:I
    ...
    :goto_c5
    sget v3, Landroid/support/v7/cardview/R$styleable;->CardView_android_minWidth:I

    invoke-virtual {v2, v3, v5}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v3

    iput v3, v0, Landroid/support/v7/widget/CardView;->mUserSetMinWidth:I

    .line 159
    sget v3, Landroid/support/v7/cardview/R$styleable;->CardView_android_minHeight:I
...
.method protected onMeasure(II)V
    ...
    invoke-interface {v0, v2}, Landroid/support/v7/widget/CardViewImpl;->getMinWidth(Landroid/support/v7/widget/CardViewDelegate;)F
